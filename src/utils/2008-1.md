...
***Com o crescimento do uso de redes sem fio, aos administradores de rede, foram lançados novos desafios: \- Permitir flexibilidade que um acesso sem fio proporciona e, ao mesmo tempo, manter a integridade e sigilo dos dados e autenticidade das pessoas, assegurando, dentre outras coisas, que os dados que ultrapassam os limites físicos da empresa, através de ondas eletromagnéticas, não possam ser, por exemplo, compreendidos por pessoas mal intencionadas; \- Assegurar que pessoas de dentro da própria empresa (funcionários insatisfeitos, visitantes mal-intencionados e funcionários de empresas terceirizadas) não possam criar pontos vulneráveis na infra-estrutura de rede através do uso de pontos de acesso não planejados pelo administrador; A proposta de nossa pesquisa é mostrar como enfrentar esses desafios e como isso foi feito ao longo do tempo.   Apresentação: 3a feira, 01/07/2008, 09:30hs, Anfiteatro do CIn***
